...
async function _unpublish(projectId, context) {
    ...
    return db.runTransaction(async (transaction) => {
        ...
        const authorized = util.isSuperAdmin(context) || isAdmin || isAuthorAndEditor || isCollaborator;
        if (!authorized) {
            throw new functions.https.HttpsError("permission-denied", "User is not a super admin, nor a group admin, nor a group editor and owner of the project, nor a collaborator");
        }
