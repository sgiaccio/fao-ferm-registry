...
const projectTabs = [
    { path: 'general', name: 'projectInfo', component: () => import('../views/project/RegistrationView.vue'), meta: { title: 'Initiative Information' } },
    { path: 'area', name: 'projectAoi', component: () => import('../views/project/AoiView.vue'), meta: { title: 'Initiative Area of Interest' } },
    { path: 'characteristics', name: 'projectCharacteristics', component: () => import('../views/project/characteristics/CharacteristicsView.vue'), meta: { title: 'Initiative Characteristics' } },
    { path: 'activities', name: 'projectActivities', component: () => import('../views/project/ActivitiesView.vue'), meta: { title: 'Initiative Activities' } },
    { path: 'ecosystems', name: 'projectEcosystems', component: () => import('../views/project/EcosystemsView.vue'), meta: { title: 'Initiative Ecosystems' } },
    { path: 'indicators', name: 'projectIndicators', component: () => import('../views/project/IndicatorsView.vue'), meta: { title: 'Initiative Indicators' } },
    { path: 'monitoring', name: 'projectMonitoring', component: () => import('../views/project/MonitoringView.vue'), meta: { title: 'Initiative Monitoring' } },
];

// Good Practices tabs are used both for editing and viewing projects, so define them once here
const bestPracticeTabs = [
    { path: 'objectives', name: 'goodPracticesObjectives', component: () => import('../views/bestpractices/ObjectivesView.vue'), meta: { title: 'Good Practice Objectives' } },
    { path: 'methodology', name: 'goodPracticesMethodology', component: () => import('../views/bestpractices/MethodologyView.vue'), meta: { title: 'Good Practice Methodology' } },
    { path: 'key-factors', name: 'goodPracticesKeyFactors', component: () => import('../views/bestpractices/KeyFactorsView.vue'), meta: { title: 'Good Practice Key Factors, Constraints and Lessons Learned' } },
    { path: 'benefits', name: 'goodPracticesBenefits', component: () => import('../views/bestpractices/BenefitsView.vue'), meta: { title: 'Good Practice Benefits and Validation' } },
    { path: 'additional-resources', name: 'goodPracticesAdditionalResources', component: () => import('../views/bestpractices/AdditionalResourcesView.vue'), meta: { title: 'Good Practice Additional Resources' } },
];
                    ...
                    children: [
                        {
                            ...
                            children: projectTabs.map(tab => ({ ...tab, meta: { ...tab.meta, title: `${tab.meta.title}` } }))
                        }, {
                            path: 'print',
                            ...
                            children: projectTabs.map(tab => ({ ...tab, name: `${tab.name}Edit`, meta: { ...tab.meta, title: `${tab.meta.title} Edit` } }))
                        },
                    ]
                }, {
                    ...
                    children: [
                        {
                            ...
                            children: bestPracticeTabs.map(tab => ({ ...tab, meta: { ...tab.meta, title: `${tab.meta.title}` } })),
                            meta: {
                                title: 'Good Practice'
                            }
                        },
                        ...
                        },
                        {
                            ...
                            children: bestPracticeTabs.map(tab => ({ ...tab, name: `${tab.name}Edit`, meta: { ...tab.meta, title: `${tab.meta.title} Edit` } })),
                        },
                    ]
                }
            ]
