                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-600">
                                        ...
                                        <p class="text-gray-600">
                                            A good practice for ecosystem restoration is a <span class="font-semibold">proven approach, technique or technology</span> that contributed to achieve one or more objectives of a restoration initiative, maximizing benefits for nature and people. <span class="font-semibold">It is usually a subset of a restoration initiative that has been applied, tested and replicated in multiple contexts and therefore, can be easily transferred and/or adapted to other initiatives with similar goals</span>. If a practice has been tested <span class="font-semibold">solely in a specific context</span>, it is considered a <span class="font-semibold">promising practice</span> that needs to be proven for replicability and adaptability to various contexts.
                                        </p>
                                        ...
                                        <ol class="ml-4 list-decimal list-outside mt-2">
                                            <li>Check if your restoration practices are <span class="font-semibold">as compliant as possible</span> with the <span class="font-semibold">ten criteria below</span> derived from the <a class="text-blue-600"
                                                   href="https://www.fao.org/documents/card/en/c/cb6591en/">ten principles for ecosystem restoration.</a></li>
                                        ...
                                        <ol class="ml-4 list-decimal list-outside mt-2">
                                            ...
                                            <!-- 8 -->
                                            <li><span class="font-semibold">Implemented in multiple contexts.</span> The practice has been tested and replicated in multiple contexts and therefore, can be easily transferred and/or adapted to other initiatives with similar goals.</li>
                                            <!-- 9 -->
                                            <li><span class="font-semibold">Properly validated.</span> The practice has been evaluated, from a technical and methodological point of view, to demonstrate that it has achieved its goals. In addition, beneficiaries of the practice have also validated its positive impacts.</li>
                                            <!-- 10 -->
