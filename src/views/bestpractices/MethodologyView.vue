...
function enableSpecifyReplicability() {
    return data.value.replicability && (data.value.replicability.toString() === "1" || data.value.replicability.toString() === "2")
}
    ...
    <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
        ...
        <div class="divide-y divide-stone-900">
            ...
            <MultiInputFormGroup
                ...
                v-model="data.implementationSteps" />
            <MultiSelectFormGroup
                :options="menus.engagement"
                v-model="data.engagement"
