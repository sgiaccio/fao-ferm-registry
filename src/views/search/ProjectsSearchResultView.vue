                ...
                >
                    ...
                    <DialogPanel class="w-full max-w-4xl rounded-md bg-white overflow-hidden min-h-64 shadow-md flex flex-col">
                        <Detail
                            ...
                            :short_description="currentResult.description"
                            ...
                            :country_iso3_codes="currentResult.country_codes_iso3"
                            :country_names="currentResult.countries"
                        />
                    </DialogPanel>
                </TransitionChild>
            </div>
    ...
    >
        ...
        >
            ...
            <img
                ...
                class="h-7 absolute top-1.5 right-1.5 rounded-sm bg-white/90 p-1 shadow-md shadow-black/20 backdrop-blur-sm"
