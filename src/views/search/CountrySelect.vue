...
<template>
    ...
    <TransitionGroup
        name="list"
        tag="ul"
        class="mt-0 flex flex-wrap gap-1.5 max-w-full"
    >
        <li
            v-for="country in selectedCountries.sort((a, b) => a.name.localeCompare(b.name))"
            :key="country.ISO3"
        ...
        >
            <div class="flex items-center max-w-full">
                ...
                <button
                    @click="selectedCountries = selectedCountries.filter(c => c.ISO3 !== country.ISO3)"
                    type="button"
