            ...
            <div class="mt-4 md:mt-6 mb-6 md:mb-8">
                ...
                <div class="hidden sm:block">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px grid auto-cols-auto grid-cols-7 dark:text-white"
                             aria-label="Tabs">
                            <div class="bg-yellow-100 dark:bg-yellow-900 col-span-4 text-center py-2 font-akrobat">Planning & Assessment</div>
                            <div class="bg-green-100 dark:bg-green-900 col-span-1 text-center py-2 font-akrobat">Implementation</div>
                            <div class="bg-blue-100 dark:bg-blue-900 col-span-2 text-center py-2 font-akrobat">Monitoring & Reporting</div>
