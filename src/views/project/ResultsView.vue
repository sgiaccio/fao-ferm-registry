                        ...
                        <div v-if="!selectedArea" class="space-y-4 py-6 pl-4">
                            ...
                            <CommittedAreaChart
                                ...
                                :areaUnderRestoration="
                                    areaUnderRestoration || 0
                                "
                                :targetArea="project.project.targetArea || 0"
                                :units="project.project.areaUnits"
                                :targetLabel="
                                    t('publicPagePreview.charts.committed')
                                "
                                :underRestorationLabel="
                                    t(
                                        'publicPagePreview.charts.underRestoration',
                                    )
                                "
                            />
                            <div v-else>
                                ...
                                >
                                    <CommittedAreaChart
                                        ...
                                        :targetLabel="
                                            t(
                                                'publicPagePreview.charts.committed',
                                            )
                                        "
                                        :underRestorationLabel="
                                            t(
                                                'publicPagePreview.charts.gef.underImprovedPractices',
                                            )
                                        "
                                        :size="otherChartSize()"
                                    />
                                    <CommittedAreaChart
                                        ...
                                        :title="
                                            t(
                                                'publicPagePreview.charts.gef.CI5',
                                            )
                                        "
                                        :targetArea="
                                            project.project
                                    ...
                                    <CommittedAreaChart
                                        ...
                                        :title="
                                            t(
                                                'publicPagePreview.charts.gef.CI1',
                                            )
                                        "
                                        :targetArea="
                                            project.project
                                    ...
                                    <CommittedAreaChart
                                        ...
                                        :title="
                                            t(
                                                'publicPagePreview.charts.gef.CI2',
                                            )
                                        "
                                        :targetArea="
                                            project.project
                                    ...
                                    <CommittedAreaChart
                                        ...
                                        :title="
                                            t(
                                                'publicPagePreview.charts.gef.CI2LDCF',
                                            )
                                        "
                                        :targetArea="
                                            project.project
                            ...
                            <ChartsSwiper
                                v-if="
                                    ...
                                    getAreaValue(projectAreas[0]).uuid
                                "
