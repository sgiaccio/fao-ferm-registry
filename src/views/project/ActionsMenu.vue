...
<template>
    <TwoStagesDialog ref="submitDialog"
    ...
    <TwoStagesDialog ref="publishDialog"
                     title="Publish initiative?"
    ...
    <TwoStagesDialog ref="rejectDialog"
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-500">
                ...
                <p>If you proceed, please provide constructive feedback to the author regarding the rejection.
                    <textarea v-model="rejectReason"
                              ...
                              placeholder="Feedback to the author"></textarea>
                </p>
            </div>
        </template>
        <template #success>
    ...
    <Menu as="div"
        ...
        <transition enter-active-class="transition ease-out duration-100"
            ...
            <MenuItems class="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                ...
                <div v-if="(!sections || sections.includes('delete')) && projectUtils.canEdit(project)"
                     class="py-1">
                    <menu-item v-slot="{ active }">
