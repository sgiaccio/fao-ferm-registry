...
async function parseDbfFromZip(f: File) {
    ...
    var parsedDBF = parsedbf(Buffer.from(arrBuf));
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div v-if="rows" class="m-6 mt-4 max-w-fit">
                                <div class="relative flex items-start">
                                    ...
                                    <div class="ml-3 text-sm">
                                        <label for="comments" class="font-medium text-gray-700">Get area name from
                                            attribute</label>
                                    </div>
                                </div>

                                <select id="location" name="location" :disabled="!getAreaName" v-model="areaNameField"
                                ...
                                <div class="text-center font-bold text-lg">{{ rows.length }} features found:</div>
