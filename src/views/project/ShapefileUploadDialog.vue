                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                                        ...
                                        <ul class="text-sm ml-4 text-gray-800 list-disc list-inside font-light">
                                            <li>Please upload a <span class="font-semibold">zip file</span> containing
                                                the <span class="font-semibold italic text-red-600">.shp, .shx,
                                                    .dbf</span>, and .<span
                                                    class="font-semibold italic text-red-600">prj</span> files.
                                            </li>
                                            <li>The shapefile can contain one or many <span
                                                class="font-semibold">points</span>, <span
                                                class="font-semibold">polygons</span>, or <span
                                                class="font-semibold">multipolygons</span>.
                                            </li>
                            ...
                            <div v-if="rows" class="m-6">
                                <div>
                                    <div class="flex items-start">
                                        <div class="flex h-5 items-center">
                                            <input id="areaName" aria-describedby="comments-description" name="comments"
                                                   type="checkbox" v-model="getAreaName"
                                                   class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        </div>
                                        <div class="ml-3 text-sm">
                                            <label for="areaName" class="font-medium text-gray-700">Get area name from
                                                attribute</label>
                                        </div>
                                    </div>
                                    <select id="areaNameSelect" name="areaNameSelect" :disabled="!getAreaName"
                                ...
                                <div>
                                    <div class="flex items-start mt-6">
                                        <div class="flex h-5 items-center">
                                            <input id="areaId" aria-describedby="comments-description" name="comments"
                                                   type="checkbox" v-model="getAreaId"
                                                   class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        </div>
                                        <div class="ml-3 text-sm">
                                            <label for="areaId" class="font-medium text-gray-700">Get area ID from
                                                attribute</label>
                                        </div>
                                    </div>
                                    <select id="areaIdSelect" name="areaIdSelect" :disabled="!getAreaId"
                                            v-model="areaIdField"
                                ...
                                <div class="border-gray-300 rounded-md border overflow-auto ">
                                    <table class="divide-y divide-gray-300 w-full">
                                        <tr class="py-2">
                                            <th class="truncate max-w-[200px] px-2 py-1" v-for="h in header">{{ h }}
                                            </th>
                                        </tr>
                                        <tr v-for="row in rows">
                                            <td class="truncate max-w-[200px] px-2 py-1" v-for="h in header">
                                                {{ row[h] }}
                                            </td>
                                        </tr>
                                    </table>
