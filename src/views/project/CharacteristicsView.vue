<template>
    <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
        ...
        <div class="text-sm text-gray-800 dark:text-zinc-300">
            ...
            <p class="mt-2">
                <span class="font-bold">Rainfall:</span> Dynamic Land Cover map at 100 m resolution (CGLS-LC100). Provides provides a primary land cover scheme using PROBA-V 100 m time-series.
                <br>
                Source: <a class="text-blue-600 underlined" target="_blank" href="https://developers.google.com/earth-engine/datasets/catalog/CGIAR_SRTM90_V4">https://developers.google.com/earth-engine/datasets/catalog/CGIAR_SRTM90_V4</a>
            </p>
            <p class="mt-2">
                <span class="font-bold">Land cover:</span> Shuttle Radar Topography Mission (SRTM) digital elevation dataset with 3 arc second (approx. 90m) spatial resolution. The vertical error of the DEM’s is reported to be less than 16m.
                <br>
