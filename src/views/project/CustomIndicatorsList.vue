...
<template>
    <ConfirmModal
        ...
        :title="t('indicators.addCustomIndicator.title')"
        :okButtonText="t('indicators.addCustomIndicator.title')"
        ...
        <div class="flex flex-col gap-y-6 mt-6">
            <div class="relative">
                ...
                <input
                    ...
                    :placeholder="t('indicators.addCustomIndicator.indicatorPlaceholder')"
            ...
            <div class="relative">
                ...
                <input
                    ...
                    id="metric"
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    :placeholder="$t('indicators.addCustomIndicator.metricPlaceholder')"
            ...
            <div class="relative">
                ...
                <input
                    ...
                    id="unit"
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    :placeholder="$t('indicators.addCustomIndicator.unitPlaceholder')"
