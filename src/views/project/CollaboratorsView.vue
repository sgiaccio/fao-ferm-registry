...
onBeforeMount(async () => {
    ...
    projectTitle.value = store.project?.project?.title || '';
            ...
            <div class="max-w-lg m-auto border rounded-lg mt-6 px-6 py-6">
                ...
                <div class="flex pt-6 justify-end">
                    <button
                        ...
                        :disabled="saving"
                        :class="[saving ? '' : 'hover:bg-indigo-200', 'inline-flex items-center rounded-md border border-transparent bg-indigo-100 px-4 py-2 text-sm font-medium text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2']">
                        Cancel
                    </button>

                    <button
                        :class="[saving? '' : 'hover:bg-indigo-500', 'mt-3 inline-flex w-full items-center justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:ml-3 sm:mt-0 sm:w-auto']"
                        @click="save"
                        :disabled="saving">
                        Save
                    </button>
