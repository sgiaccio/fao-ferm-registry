                        ...
                        <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                            <div>
                                <div class="text-center">
                                    <h1>Request to join an institution</h1>
                                    <h2>or</h2>
                                    <button type="button"
                                                class="rounded-md bg-indigo-600 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Propose a new one</button>
                                    </div>
                                ...
                                <div class="mt-5 sm:mt-6">
                                    <button type="button"
                                            ...
                                            @click="onClose">{{ buttonText }}</button>
                                </div>
                            </DialogPanel>
                        </TransitionChild>
                    </div>
