...
onMounted(async () => {
    try {
        ...
        if (authStore.isAdmin) {
            ...
            const groupsWhereAdmin = Object.keys(authStore.privileges).filter(
                (k) => authStore.privileges[k] === 'admin',
            );
            allGroups.value = Object.fromEntries(
                Object.entries(groups).filter(([gid]) =>
                    groupsWhereAdmin.includes(gid),
                ),
            );
        }
    } catch (e) {
...
async function edit(user: User) {
    ...
    if (!isAdmin) {
        ...
        privileges = Object.fromEntries(
            Object.entries(privileges).filter(([gid]) =>
                groupsWhereAdmin.includes(gid),
            ),
        );
    }
...
<template>
    <TabTemplate title="Users">
        <div class="mt-8 flex flex-col">
            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                >
                    <div v-if="authStore.isAdmin" class="pb-6">
                        <button
                            @click="addUser"
                                ...
                                >
                                    ...
                                    >
                                        <div class="text-gray-900">
                                            {{
                                                user.metadata.lastSignInTime?.substring(
                                                    0,
                                                    16,
                                                ) || '-'
                                            }}
                                    ...
                                    >
                                        <div class="text-gray-900">
                                            {{
                                                user.metadata.creationTime.substring(
                                                    0,
                                                    16,
                                                )
                                            }}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                                            ...
                                                            >
                                                                <tr
                                                                    v-for="(
                                                                        level,
                                                                        group
                                                                    ) in userToEdit.privileges ||
                                                                    []"
                                                                    :key="group"
                                                                >
                                                                    <td
                                                                        class="whitespace-nowrap py-2 pl-6 pr-3 text-sm text-gray-500 sm:pl-0"
                                                                    >
                                                                        {{
                                                                            allGroups[
                                                                                group
                                                                    ...
                                                                    <td
                                                                        class="relative whitespace-nowrap py-2 pl-3 pr-6 text-right text-sm font-medium sm:pr-0"
                                                                    >
                                                                        <span
                                                                            @click="
                                                                                () =>
                                ...
                                <div
                                    class="mt-6 py-3 px-4 bg-gray-100 border border-1 border-gray-300 rounded-lg"
                                >
                                ...
                                <button
                                    ...
                                    :class="[
                                        isSaving
                                            ...
                                            : 'bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:indigo-600 focus:ring-offset-2',
                                        'inline-flex w-full justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium text-white shadow-sm sm:w-auto sm:text-sm sm:ml-3',
                                    ]"
                                    @click="save"
                                    :disabled="isSaving"
                                >
    ...
    <!-- User add dialog -->
    <TransitionRoot as="template" :show="!!userToAdd">
        <Dialog as="div" class="relative z-10" @close="">
            <TransitionChild
                as="template"
                enter="ease-out duration-300"
